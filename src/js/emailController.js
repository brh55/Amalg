...
setTimeout(function () {
	// When the :NY element arrives perform injection
/**
 * Contains the emails and other data as a global model
 * @type {Object}
 */
var model = [];
...
fetchEmails();
	...
	document.getElementById(':ny').innerHTML = buildHtml(model);
}, 4500);
